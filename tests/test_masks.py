...
@pytest.mark.parametrize("number, expected", [
    ("1234 5678 9012 345", "Не корректно введены данные"),
    ("1234 5678 9012 3453 2", "Не корректно введены данные")
])
...
@pytest.mark.parametrize("number, expected", [
    ("7365410843013587430", "Не корректно введены данные"),
    ("736541084301358743052", "Не корректно введены данные")
])
