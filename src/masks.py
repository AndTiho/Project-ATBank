...
def get_mask_card_number(card_number: str) -> str:
    ...
    """
    mask_card_logger.info(f'Запуск модуля')
    ...
    mask_card_logger.info(f'Функция отработала корректно. Завершение работы')
...
def get_mask_account(account: str) -> str:
    ...
    """
    mask_account_logger.info(f'Запуск работы модуля.')
    ...
    if len(mask_account) != 20:
        mask_account_logger.error(f'{len(mask_account)}: Длина номера не соответствует требованиям в 20 символов. Завершение работы..')
        return "Не корректно введены данные"
    mask_account_logger.info(f'Программа отработала корректно. Завершение работы')
